                ...
                <div className="wrapper">
                    <div className="lg:max-w-md">
                        ...
                        <div className="space-y-5 mt-7 pe-10">
                            ...
                            <p>
                                It drives Apple Intèlligence ori iPad Pro, so you can write, create, and accomplish more with ease. All in a design that's unbelievably thin, light, and powerful.
                            </p>
                            <p>
